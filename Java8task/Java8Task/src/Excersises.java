...
public class Excersises {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("All Products of Category Books : ");
        Stream<Product> books = products.stream().filter(book-> book.getCategory().equals("Books"));
        books.forEach(book-> System.out.println(book.toString()));
        System.out.println("-------------------------------------------------------");

        System.out.println("All Books with price Greater than 100");
        Stream<Product> someBooks = products.stream().filter(book-> book.getCategory().equals("Books") && book.getPrice()>100);
        someBooks.forEach(book-> System.out.println(book.toString()));
        System.out.println("---------------------------------------------------------");

        System.out.println("All products of Category Toys with 10% discount");
        Stream<Product> toys =products.stream().filter(toy->toy.getCategory().equals("Toys"));
        toys.forEach(toy->{
            toy.setPrice(toy.getPrice()*0.9);
            System.out.println(toy.toString());
        });
        System.out.println("--------------------------------------");

        System.out.println("Cheapest Book : ");
        Stream<Product> books3 = products.stream().filter(book-> book.getCategory().equals("Books"));
        Product p = books3.min((book1,book2)->Double.compare(book1.getPrice(),book2.getPrice())).orElse(null);
    ...
    public static List<Product> addDummyData()
    {
        ...
        Collections.addAll(products,
                ...
                new Product(16, "aut ex ducimus", "Books", 85),

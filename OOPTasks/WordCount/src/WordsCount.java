...
public class WordsCount {
    public static void main(String [] args){
        try {
            FileOutputStream fos = new FileOutputStream("Lincoln.txt" );
            String content = "Four score and seven years ago our fathers brought forth on this continent, a new nation,\n" +
        ...
        try {
            FileInputStream fis = new FileInputStream("Lincoln.txt");
